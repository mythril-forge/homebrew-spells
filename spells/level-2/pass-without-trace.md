...
For the duration, each creature you choose within 30 feet of you (including you) has a `+10` bonus to Dexterity checks and can't be tracked except by magical means.
